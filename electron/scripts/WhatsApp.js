 ...
 * 监听来自抽屉的消息
 */
window.electronAPI.ipcRenderer.on('apply-polish-to-draft', (event, text) => {
    replaceInputWithPdrSuggestion(text);
});

window.electronAPI.ipcRenderer.on('send-polished-message', (event, text) => {
